    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">BILLING PROCESS</h5>
...
$sql = "SELECT name,email,Address,TEL_NO,CreditCard_number,Exp_Month FROM billing";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
      ...
      <tr>
                    ...
                    <td><?php echo $rows['CreditCard_number'];?></td>
                    <td><?php echo $rows['Exp_Month'];?></td>
                  </tr>
</div>
